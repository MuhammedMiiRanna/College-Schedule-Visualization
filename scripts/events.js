...
export function fillSelectedTypeList(selectedOption, eventsData) {
  ...
  switch (selectedOption) {
    ...
    case "Scale":
    case "Location":
      type = Array.isArray(showsBy[selectedOption])
        ? showsBy[selectedOption]
        : Object.keys(showsBy[selectedOption]);
      break;
...
function fillEventCard(eventData) {
  ...
  cardBody.innerHTML =
    "<ul>" +
    '  <li>name: <span id="event-card-name">' +
    eventData["name"] +
    "</span></li>" +
    '  <li>orginizer: <span id="event-card-orginizer">' +
    eventData["orginizer"] +
    "</span></li>" +
    '  <li>location: <span id="event-card-location">' +
    eventData["location"] +
    "</span></li>" +
    '  <li>year: <span id="event-card-year">' +
    eventData["year"] +
    "</span></li>" +
    '  <li>month: <span id="event-card-month">' +
    eventData["month"] +
    +"</span></li>" +
    '  <li>day: <span id="event-card-day">' +
    eventData["day"] +
    "</span></li>" +
    '  <li>descreption: <span id="event-card-descreption">' +
    eventData["descreption"] +
    "</span></li>" +
    "</ul>";
